import { Image, ImageBackground, StyleSheet, Text, TouchableOpacity, useWindowDimensions, View, ScrollView } from 'react-native';
...
const Videos = () => {
  ...
  const videoData = [{ vid: require('../../../assets/images/big_buck_bunny_720p_1mb.mp4') }];
    ...
    <ScrollView>
      <View style={{ flexDirection: 'row' }}>
        <View style={{ width: dimension.width / 2 }}>
          ...
          >
            <ImageBackground source={require('../../../assets/icons/youtube.png')} style={{ height: 60, width: 60 }} resizeMode="contain">
              <View
                style={{
                  height: 24,
                  width: 24,
        ...
        <View style={{ width: dimension.width / 2 }}>
          ...
          <TouchableOpacity
            style={{ marginTop: 20, marginHorizontal: 20, alignSelf: 'flex-end' }}
      ...
      {/* <View style={{ width: dimension.width, backgroundColor: '#000' }}>
        <Thumbnail imageWidth={200} url="https://www.youtube.com/watch?v=lgj3D5-jJ74" />
      </View> */}
