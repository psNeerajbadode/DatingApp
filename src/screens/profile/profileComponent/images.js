...
const Images = () => {
  ...
  return (
    <View>
      <View
        style={{ flexDirection: 'row', marginTop: 20, backgroundColor: ThemeMode.selectedTheme ? theme.colors.primary : theme.colors.primaryBlack }}
      >
            ...
            {photos.map((v, i) => (
              <View>
                {i != 2 || (
                  ...
                  >
                    <Image source={v.img} style={{ width: (dimension.width - 50) / 2, height: 253, resizeMode: 'contain', borderRadius: 20 }} />
                  </TouchableOpacity>
                )}
              </View>
            ))}
              ...
              (v, i) =>
                (i != 1 && i != 3) || (
                  ...
                  >
                    <Image
                      source={v.img}
                      style={{ width: (dimension.width - 50) / 2, height: i == 1 ? 281 : 130, resizeMode: 'cover', borderRadius: 20 }}
                    />
                  </TouchableOpacity>
                ),
            )}
      ...
      {photos.map(
        (v, i) =>
          (i != 4 && i != 5) || (
            <TouchableOpacity onPress={() => navigation.navigate('viewSelfMedia', { imgIndex: i })} style={{ alignSelf: 'center', marginTop: 20 }}>
              <Image source={v.img} style={{ width: dimension.width - 40, height: 143, resizeMode: 'cover', borderRadius: 20 }} />
            </TouchableOpacity>
          ),
      )}
      <Option
