    ...
    <View style={{ flex: 1, backgroundColor: ThemeMode.selectedTheme ? theme.colors.primary : theme.colors.primaryBlack }}>
      ...
      <ScrollView keyboardShouldPersistTaps="handled">
        ...
        <TextInputFormat
          ...
          showMess={rePassword == '' || (rePassword != null && !validPass(rePassword)) ? true : false}
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginHorizontal: 20, marginTop: 30 }}>
          ...
          >
            ...
            <TextFormatted
              style={{ textDecorationLine: 'underline', color: ThemeMode.selectedTheme ? theme.colors.primaryBlack : theme.colors.primary }}
        ...
        <Button
          opacity={validateEmail(email) && password != '' && validPass(password) == rePassword && toggle ? 1 : 0.5}
          onPress={() => Signup()}
          Loading={Loading}
          buttonName="Create Account"
          color={'#fff'}
          disabled={validateEmail(email) && password != '' && validPass(password) == rePassword && toggle ? false : true}
          marginTop={36}
        />
        ...
        >
          ...
          <TextFormatted
            style={{ fontSize: 14, fontWeight: '600', color: ThemeMode.selectedTheme ? theme.colors.primaryBlack : theme.colors.primary }}
