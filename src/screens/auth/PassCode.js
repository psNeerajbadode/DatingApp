    ...
    <View style={{ flex: 1, backgroundColor: ThemeMode.selectedTheme ? theme.colors.primary : theme.colors.primaryBlack }}>
      <View style={{ paddingBottom: 18 }}>
        <HeaderImageShadow height={360}>
          ...
          <TextFormatted style={{ fontSize: 16, fontWeight: '400', color: '#FFFFFF', textAlign: 'center', marginTop: 15 }}>
            Good evening,
          </TextFormatted>
            ...
            .map((_, i) => (
              <View
                style={{
                  height: 25,
                  width: 25,
                  backgroundColor: ThemeMode.selectedTheme ? theme.colors.primary : theme.colors.darkGrey,
      ...
      <ScrollView>
        <View style={{ flexDirection: 'row', width: 300, flexWrap: 'wrap', alignSelf: 'center', marginTop: 10 }}>
          {Array(11)
            ...
            .map((_, i) => (
              ...
              >
                ...
                >
                  {i == 9 ? (
                    <Icon name="arrow-left" size={30} color={ThemeMode.selectedTheme ? theme.colors.primaryBlack : theme.colors.primary} />
                  ) : i == 10 ? (
                    0
                  ) : (
                    i + 1
          ...
          <TouchableOpacity style={{ marginLeft: 24 }} onPress={() => navigation.replace('FingerPrint')}>
            <Image source={require('../../assets/icons/fingerprint_1.png')} style={{ resizeMode: 'contain', height: 50, width: 50 }} />
          </TouchableOpacity>
        </View>
        <TextFormatted
          style={{
